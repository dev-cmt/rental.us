    ...
    <div class="container">
        <nav id="navigation" class="navigation navigation-landscape">
            <div class="nav-header">
                <a class="nav-brand text-logo" href="{{url('/')}}">
                    ...
                    <img src="{{ asset($settings ? $settings->logo : '') }}" height="45" alt="logo">
                </a>
                ...
                <div class="mobile_nav">
                    <ul>
                        ...
                        <!-- Application -->
                        <li>
                            <a href="{{route('page.application-from')}}" class="text-main">
                                <span class="svg-icon svg-icon-2hx">
            ...
            <div class="nav-menus-wrapper" style="transition-property: none;">
                ...
                <ul class="nav-menu nav-menu-social align-to-right">
                    ...
                    <li class="add-listing">
                        <a href="{{route('page.application-from')}}" class="bg-main">
            ...
            <div class="tab-pane fade show active" id="pills-compare" role="tabpanel"
                ...
                <div class="sidebar_featured_property">
                    ...
                    <div class="input-group">
                        <a href="compare-property.html" class="btn btn-light-main fw-medium full-width">View & Compare</a>
                    </div>
                </div>
            </div>
