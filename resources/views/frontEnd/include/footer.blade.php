<!-- ============================ Call To Action ================================== -->
<section class="bg-main call-to-act-wrap d-none">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
<footer class="dark-footer skin-dark-footer">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="footer-widget">
                    <a class="nav-footer-logo" href="{{url('/')}}">
    ...
    <div class="footer-bottom" style="height: 140px; display: flex ; justify-content: space-around; align-items: center;">
        <div class="container">
